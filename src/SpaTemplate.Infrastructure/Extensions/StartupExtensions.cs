...
namespace SpaTemplate.Infrastructure
{
	...
	public static class StartupExtensions
	{
		...
		public static IServiceProvider AddCustomDependencyInjectionProvider(this IServiceCollection services)
		{
...
#pragma warning restore IDISP005 // Return type should indicate that the value should be disposed.
		...
		public static void AddCustomInMemoryDbContext(this IServiceCollection services) =>
			services.AddDbContext<ApplicationDbContext>(options => options.UseInMemoryDatabase("rest"));
	}
}