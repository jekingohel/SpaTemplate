...
export interface ICoursesService {
    ...
    coursesGet(studentId: string, id: string, accept: string | null | undefined, version: string | null): Observable<ProblemDetails | null>;
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ProblemDetails | null>><any>_observableThrow(e);
                }
            } else
                return <Observable<ProblemDetails | null>><any>_observableThrow(response_);
        }));
    }

    protected processCoursesGet(response: HttpResponseBase): Observable<ProblemDetails | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export interface IPeopleCollectionsService {
    ...
    peopleCollectionsGet(ids: string[] | null, version: string | null): Observable<ProblemDetails | null>;
}
...
export class PeopleCollectionsService implements IPeopleCollectionsService {
    ...
    protected processPeopleCollectionsGet(response: HttpResponseBase): Observable<ProblemDetails | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
